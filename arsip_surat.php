...
// Query untuk mengambil data pengajuan_surat yang statusnya diterima
...
?>
    <tr>
        ...
        <td>
            <?php 
                $tanggal = strtotime($row['tgl_ajuan']);
                $bulan = [
...
?>
    <tr>
        <td colspan="11" class="text-center">Data pengajuan surat masih kosong</td>
    </tr>
<?php } ?>
</tbody>
<tfoot>
