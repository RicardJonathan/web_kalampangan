...
<head>
    ...
    <title>Detail Kegiatan - Kelurahan Kalampangan</title>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-8 text-center">
                <ul class="breadcrumbs">
                    ...
                    <li>
                        <a href="berita_kegiatan.php" class="hover:text-primary-600 transition">
                            Kegiatan
                        </a>
                    </li>
                    <li class="separator">
                    ...
                    <li>
                        <span class="current-page">Detail Kegiatan</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6 md:p-8">
                <!-- <span class="activity-badge">Kegiatan</span> -->
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4"><?php echo htmlspecialchars($row['judul']); ?></h1>
                ...
                <div class="activity-details">
                    ...
                    <div class="activity-detail-item">
                        ...
                        <span><?php echo htmlspecialchars($row['lokasi'] ?? 'Lokasi tidak tersedia'); ?></span>
                    </div>
                </div>
                ...
                <div class="activity-content text-gray-700">
                    <?php echo nl2br($row['deskripsi']); ?>
                </div>
                
                <div class="mt-10">
                    <a href="berita_kegiatan.php" class="inline-flex items-center px-6 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition shadow-md">
