...
<html lang="en">
  ...
  <div  class="page_cover parallax-window" data-parallax="scroll" style="background-image: url('../web_kalampangan/images/banner/bg_4.jpg');">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="konten_post">
                    <img src="../web_kalampangan/images/berita/image_1.jpg" class="img-fluid" alt="">
                    <div class="konten_details"> 
                      <a href="baca_artikel.html">
                        <h4>Surat Keterangan Usaha (SKU)</h4>
                      </a>
                      <p class="text-justify">- Foto Copy KTP 1 Lembar <br>- Foto Copy KK 1 Lembar <br>- Foto UK 3x4 atau 4x6 2 Lembar</p>
                      <a class="btn btn-primary" href="baca_artikel.html">Baca Selengkapnya</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="konten_post">
                    <img src="img/berita/image_2.jpg" class="img-fluid" alt="">
                    <div class="konten_details">
                      <a href="baca_artikel.html">
                        <h4>Surat Keterangan Domisili</h4>
                      </a>
                      <p class="text-justify">- Foto Copy KTP & KK <br>- Surat Pengantar RT/RW <br>- Mengisi Formulir Permohonan</p>
                      <a class="btn btn-primary" href="baca_artikel.html">Baca Selengkapnya</a>
                    </div>
                  </div>
                </div>
