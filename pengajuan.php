...
<head>
    ...
    <title>Pengajuan - Kelurahan Kalampangan</title>
    ...
    <div class="page_cover relative" style="background-image: url('images/slider/tulisanDepan.jpeg');">
        ...
        <div class="container mx-auto px-4 relative z-10 h-full flex items-center justify-center">
            <!-- <div class="w-full text-center">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Layanan Pengajuan</h1>
                <p class="text-xl text-white opacity-90 max-w-2xl mx-auto">Ajukan berbagai keperluan administrasi secara online dengan mudah dan cepat</p>
            </div> -->
        </div>
        ...
        <div class="breadcrumbs-container">
            <ul class="breadcrumbs">
                ...
                <li>
                    <span class="current-page">Pengajuan</span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-primary-900 mb-4">Jenis Layanan Pengajuan</h2>
                <p class="text-primary-700 max-w-2xl mx-auto">Pilih jenis layanan yang Anda butuhkan dan ikuti petunjuk pengajuan</p>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Surat Keterangan Usaha -->
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="bg-primary-100 p-3 rounded-full mr-4">
                            <i class="fas fa-briefcase text-primary-600 text-xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan Usaha (SKU)</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                            <span>Foto diri UK 3x4 atau 4x6 (2 lembar)</span>
                        </li>
                    </ul>
                    <a href="https://drive.google.com/drive/folders/18F-x70xalPZt0n0kZDTVidNQHD3oQ_rd" class="btn-primary py-2 px-6 rounded-full inline-flex items-center">
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="bg-primary-100 p-3 rounded-full mr-4">
                            <i class="fas fa-hands-helping text-primary-600 text-xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan Tidak Mampu (SKTM)</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                            <span>Foto Formulir yang sudah diisi dan TTD RT</span>
                        </li>
                    </ul>
                    <a href="https://drive.google.com/drive/folders/18F-x70xalPZt0n0kZDTVidNQHD3oQ_rd" class="btn-primary py-2 px-6 rounded-full inline-flex items-center">
                        <i class="fas fa-download mr-2"></i> Download Formulir
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="bg-primary-100 p-3 rounded-full mr-4">
                            <i class="fas fa-cross text-primary-600 text-xl"></i>
                        </div>
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        <div class="bg-primary-100 p-3 rounded-full mr-4">
                            <i class="fas fa-baby text-primary-600 text-xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan Kelahiran</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan untuk Menikah</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-primary-900">Pengajuan PBB Baru</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                            <span>Foto Sertifikat/IMB</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                            <span>Foto Formulir yang sudah diisi</span>
                        </li>
                    </ul>
                    <a href="https://drive.google.com/drive/folders/18F-x70xalPZt0n0kZDTVidNQHD3oQ_rd" class="btn-primary py-2 px-6 rounded-full inline-flex items-center">
                        <i class="fas fa-download mr-2"></i> Download Formulir
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan Berkelakuan Baik</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
                ...
                <div class="service-card bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-primary-900">Surat Keterangan Ahli Waris</h3>
                    </div>
                    <ul class="text-primary-700 mb-6 space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-500 mt-1 mr-2"></i>
            ...
            <div class="mt-16 bg-primary-50 rounded-xl p-6 border border-primary-100">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-primary-900 mb-2">Informasi Pentang</h3>
                        <p class="text-primary-700">
                            Setelah mendownload formulir dan mengisi formulir, untuk pengajuan surat silahkan login terlebih dahulu. 
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <!-- <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="index.php" class="text-primary-200 hover:text-white transition">Beranda</a></li>
                        <li><a href="tentang.php" class="text-primary-200 hover:text-white transition">Tentang</a></li>
                        <li><a href="pengajuan.php" class="text-primary-200 hover:text-white transition">Pengajuan</a></li>
                    </ul>
                </div> -->
