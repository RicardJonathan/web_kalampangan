...
<head>
    ...
    <title>Pengumuman - Kelurahan Kalampangan</title>
    ...
    <div class="page_cover relative" style="background-image: url('images/slider/tulisanDepan.jpeg');">
        ...
        <div class="container mx-auto px-4 relative z-10 h-full flex items-center justify-center">
            <div class="w-full text-center">
                <div class="page_cover_content">
                    <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 animate-fade-in">Pengumuman</h1>
                    <p class="text-xl text-white/90 max-w-2xl mx-auto">Informasi terbaru dari Kelurahan Kalampangan</p>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumbs-container">
            <ul class="breadcrumbs">
                ...
                <li>
                    <span class="current-page">Pengumuman</span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <span class="text-primary-600 font-semibold text-lg">Informasi Terkini</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mt-2">Pengumuman Kelurahan Kalampangan</h2>
                <p class="text-gray-600 max-w-2xl mx-auto mt-4">Dapatkan informasi terbaru seputar pengumuman resmi dari Kelurahan Kalampangan</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="announcement-card bg-white">
                    <div class="overflow-hidden">
                        <img src="./images/fotopengumuman/<?php echo $row['foto']; ?>" 
                             alt="<?php echo htmlspecialchars($row['judul']); ?>" 
                             class="announcement-image w-full">
                    </div>
                    <div class="announcement-content">
                        ...
                        <p class="announcement-excerpt"><?php echo substr(strip_tags($row['deskripsi']), 0, 120); ?>...</p>
                        <a href="detail_pengumuman.php?id=<?php echo $row['id']; ?>" 
            ...
            <!-- <div class="text-center mt-12">
                <a href="#" class="inline-flex items-center px-6 py-3 border border-primary-500 text-primary-600 rounded-full hover:bg-primary-50 transition">
