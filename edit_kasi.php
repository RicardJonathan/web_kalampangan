...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM kasi WHERE id = '$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_nip_query = "SELECT * FROM kasi WHERE nip = '$nip' AND id != '$id'";
    $check_nip_result = mysqli_query($koneksi, $check_nip_query);

    $check_username_query = "SELECT * FROM kasi WHERE username = '$username' AND id != '$id'";
    ...
    if (mysqli_num_rows($check_nip_result) > 0) {
        ...
        if (!empty($password)) {
            ...
            $update_query = "UPDATE kasi SET nama='$nama', nip='$nip', pangkat='$pangkat', golongan='$golongan', username='$username', password='$hashed_password' WHERE id='$id'";
        } else {
            $update_query = "UPDATE kasi SET nama='$nama', nip='$nip', pangkat='$pangkat', golongan='$golongan', username='$username' WHERE id='$id'";
        }
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                <h4 class="card-title">Edit Data Kasi</h4>
                            <div class="card-table">

                            <div class="form-validation">
                                <form class="form-valide" action="edit_kasi.php?id=<?php echo $id; ?>" method="post">
