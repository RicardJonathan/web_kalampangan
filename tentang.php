    ...
    <div class="page_cover relative" style="background-image: url('images/slider/tulisanDepan.jpeg');">
        ...
        <div class="breadcrumbs-container">
            <ul class="breadcrumbs">
                ...
                <li>
                    <span class="current-page">Tentang Kami</span>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <div class="md:w-5/12">
                    <div class="about_img overflow-hidden rounded-xl shadow-xl">
                        <img src="./images/logo/logo.png" class="w-full h-auto object-cover" alt="Logo Kelurahan Kalampangan">
                    </div>
                </div>
                
                <div class="md:w-7/12">
                    <h2 class="text-3xl font-bold text-primary-900 mb-6">Kelurahan <span class="gradient-text">Kalampangan</span></h2>
                    
                    <div class="space-y-4 text-primary-700">
