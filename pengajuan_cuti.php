...
// Query untuk mengambil data cuti milik pengguna yang statusnya selain "diterima"
$query = "SELECT cuti.id AS cuti_id, cuti.tgl_ajuan, cuti.jenis_cuti, cuti.tanggal_mulai, cuti.alasan_penolakan, cuti.tanggal_akhir, cuti.lama_cuti, cuti.alasan_cuti, 
                 cuti.catatan, cuti.alamat_cuti, cuti.status, user.nip, user.nama
          FROM cuti
          INNER JOIN user ON cuti.user_id = user.id
          WHERE user.id = ? AND cuti.status != 'diterima' -- Kondisi untuk status selain 'diterima'
...
if ($result->num_rows > 0) {
    ...
    $data_cuti = []; // Jika tidak ada data, array kosong
}
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <a href="tambah_pengajuan.php" class="btn btn-primary d-flex align-items-center"
                                        style="width: 140px;">
